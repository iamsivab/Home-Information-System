...
<main class="container p-4">
    ...
    <h3 style="color:black;" align="center">Delete Branch Information from Branch Operations</h3>
    <ul class="b">
    <h3 style="color:green;" align="center">Delete your Branch Information</h3> 
    </ul>
    </section>
    </div>
...
<form name = "DeleteForm" method = "GET" action = "delete_branch_end.php">

<ul class="b">
    <h3 style="color:black;" align="center">Select Branch Number</h3> 
    </ul> 
